...
export default function Navigation() {
  ...
  const navItems = [
    { to: '/bitcoin-bad-takes/', label: 'Daily Take', icon: Bitcoin },
    { to: '/bitcoin-bad-takes/leaderboard', label: 'Leaderboard', icon: Trophy },
    { to: '/bitcoin-bad-takes/submit', label: 'Submit', icon: Send },
  ];
      ...
      <div className="container flex h-12 max-w-screen-2xl items-center justify-between px-4">
        <div className="flex items-center gap-4">
          ...
          <span className="hidden sm:block text-sm text-muted-foreground">
            The worst Bitcoin takes from media and experts
          </span>
        </div>
