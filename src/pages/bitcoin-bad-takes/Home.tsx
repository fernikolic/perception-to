    ...
    <div>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-white font-bold">Loading content...</p>
        </div>
      ) : error ? (
        <div className="text-center py-20">
          <div className="max-w-md mx-auto">
            <p className="text-red-400 font-bold mb-2">Unable to load content</p>
        ...
        <div className="relative max-w-5xl mx-auto px-8">
          <div className="relative flex items-start justify-center min-h-[600px]">
            ...
            <div className="absolute -left-6 sm:-left-12 lg:-left-20 top-1/2 -translate-y-1/2 z-10 flex flex-col items-center gap-4">
            ...
            <button
              ...
              className="absolute -right-6 sm:-right-12 lg:-right-20 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-background/80 backdrop-blur-md border border-border/20 shadow-lg hover:shadow-xl hover:bg-background transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:bg-background/80 group"
            >
              <svg className="w-5 h-5 text-muted-foreground group-hover:text-foreground transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center py-20">
          <div className="max-w-md mx-auto">
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-white text-black font-bold hover:bg-white/90 transition-all duration-300 hover:scale-105"
            >
              Submit a take
            </a>
          </div>
