        ...
        <div className="mx-auto max-w-[1800px] px-6 sm:px-8 py-8 sm:py-12 lg:py-16 lg:px-12">
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl">
            <div className="flex flex-col-reverse lg:flex-row min-h-[200px] lg:min-h-[600px]">
              {/* Layered Sine Waves - Left Side on Desktop, Hidden on Mobile (50%) */}
              ...
              <div className="w-full lg:w-1/2 px-6 sm:px-8 lg:pl-16 lg:pr-16 py-8 sm:py-12 lg:py-16 flex flex-col justify-center" style={{ background: '#F0EEE6' }}>
