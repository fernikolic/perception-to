...
const posts = getPostsByTag(allPosts, 'reports');
...
export default function BMRReportsPage() {
  return (
    <>
      <SEO
        title="Reports - Bitcoin Market Analysis & Quarterly Research"
        description="Quarterly reports and in-depth analysis of Bitcoin market perception, media coverage trends, and sentiment patterns from Bitcoin Perception."
        keywords={[
          'bitcoin quarterly reports',
          'bitcoin market analysis',
          'crypto research reports',
          'bitcoin media coverage report',
          'bitcoin sentiment report'
        ]}
        url="https://perception.to/bitcoin-media-research/reports"
      />
            ...
            <div className="flex items-start gap-6 mb-8">
              ...
              <div>
                ...
                <p className="text-lg text-black/70 font-light leading-relaxed max-w-2xl">
                  Quarterly analyses and in-depth research on Bitcoin market perception, media coverage trends, and sentiment patterns.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            {posts.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-black/60 text-lg mb-6">No reports available yet.</p>
        ...
        <section className="py-24 px-6 sm:px-16 lg:px-32 bg-black">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/60 mb-10">
              Subscribe to receive our quarterly reports directly in your inbox.
            </p>
