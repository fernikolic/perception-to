  ...
  return (
    <>
      <SEO
        ...
        description="Back your stories with real sentiment data and trend analysis from 100+ sources. Track with watchlists, organize in Spaces, cite with confidence."
          ...
          <div className="mx-auto max-w-[1800px] px-6 sm:px-8 py-8 sm:py-12 lg:py-16 lg:px-12">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <div className="flex flex-col lg:flex-row min-h-[600px]">
                {/* Kaleidoscope Variation 3 - Left Side (50%) */}
                  ...
                  <div className="w-full max-w-2xl">
                    ...
                    <div className="mb-6 sm:mb-8 lg:mb-10 text-center lg:text-left">
                      <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-black/70 font-semibold mb-3">
                        Back your stories with real data from 100+{'\u00A0'}sources.
                      </p>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-light text-gray-900 leading-relaxed">
                You're covering Bitcoin adoption or a controversy. Editors want data. You don't have time to manually track coverage across 100+ sources. Generic social media sentiment doesn't cut it for serious reporting.
              </p>
            </div>
          </div>
        </section>
                ...
                {[
                  {
                    ...
                    description: "Set up watchlists for topics, companies, or people. We monitor 100+ sources. You get the data."
                  },
                  {
        ...
        <section className="py-24 sm:py-32 border-b border-gray-200">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <p className="text-2xl sm:text-3xl md:text-4xl font-light text-gray-900 leading-relaxed">
