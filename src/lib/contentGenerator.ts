...
export function generateMetaDescription(keyword: KeywordData): string {
  const templates = {
    informational: `Comprehensive ${keyword.fullKeyword} analysis with real-time data from 450+ sources. Professional insights for traders, analysts, and investors.`,
